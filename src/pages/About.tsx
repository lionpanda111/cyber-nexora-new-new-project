            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
                <div className="space-y-4 sm:space-y-6 text-base sm:text-lg text-muted-foreground order-2 lg:order-1">
                  <p>
                    Cyber Nexora is a leading cybersecurity firm specializing in Vulnerability Assessment and Penetration Testing (VAPT), security audits, and comprehensive cyber defense solutions. Based in Surat, Gujarat, we serve clients across India and internationally.
                  </p>
                  <p>
                    Our team comprises certified security professionals with extensive experience in identifying, analyzing, and mitigating cybersecurity risks. We leverage cutting-edge tools and methodologies to provide actionable insights that strengthen our clients' security posture.
                  </p>
                  <p>
                    With over 500 enterprises secured and 10,000+ vulnerabilities successfully remediated, we have established ourselves as a trusted partner for organizations seeking to protect their critical digital infrastructure.
                  </p>
                </div>
                <div className="relative order-1 lg:order-2">
                  <img 
                    src={securityAbstract} 
                    alt="Cyber Nexora cybersecurity and digital protection illustration" 
